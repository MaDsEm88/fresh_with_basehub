import { HeroBlogSubtitle, HeroBlogTitle } from "@/components/Herotext.tsx";
    ...
    <>
      <Container className="w-full  md:max-w-[60vw] mt-[4rem] items-center justify-center text-center max-w-auto">
        <section className="gap-4 md:justify-between ">
          ...
          <HeroBlogSubtitle>
            An example on how a blog could look like with the use of{" "}
            <a href="https://basehub.com">
              <span className="text-[#da6e1f] underline">Basehub.com</span>
            </a>
          </HeroBlogSubtitle>
