            ...
            <RichText
              components={{
                ...
                h1(props) {
                  return (
                    <h1
                      className="mb-[1rem] text-left font-manrope_1 opacity-90 text-[20px] md:text-[26px]"
                      {...props}
                    />
                  );
                },
                h2(props) {
                  return (
                    <h2
                      className="mb-[1rem]  text-left  font-manrope_1 opacity-90 text-[18px] md:text-[24px]"
                      {...props}
                    />
                  );
                },
                h3(props) {
                  return (
                    <h3
                      className="mb-[1rem]  text-left  font-manrope_1 opacity-90 text-[16px] md:text-[22px]"
                      {...props}
                    />
                  );
                },
                p(props) {
                  return (
                    <p
                      className="mb-[2rem]  text-left  font-manrope_1 opacity-60 text-[14px] md:text-[16px]"
                      {...props}
                    />
                  );
                },
